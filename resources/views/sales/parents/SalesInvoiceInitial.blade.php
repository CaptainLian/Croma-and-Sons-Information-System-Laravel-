...
<head>
  ...
  <!--dynamic table-->
  <link href="{{URL::asset('assets/advanced-datatable/media/css/demo_page.css')}}" rel="stylesheet" />
  <link href="{{URL::asset('assets/advanced-datatable/media/css/demo_table.css')}}" rel="stylesheet" />
