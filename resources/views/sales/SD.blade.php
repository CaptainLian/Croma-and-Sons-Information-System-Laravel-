@extends('sales.parents.SalesDashboard')

@section('sidebar-contents')
   @include('sales.chain.sidebar', ['active' => 'home'])
@endsection
...
countUp3({{$pendingDeliveryReceipts}});
